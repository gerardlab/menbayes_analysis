...
ggsave("./output/blue/blue_logbf_hist.pdf", plot = last_plot(), width = 4, height = 3, units = "in")
...
ggsave("./output/blue/blue_qq.pdf", plot = last_plot(), width = 4, height = 4, units = "in")
...
ggsave("./output/blue/chr_dr_scatter.pdf", plot = last_plot(), width = 4, height = 4, units = "in")
